...
export function isExpired(timestampMs, ttlMs) {
 ...
 */
export function canonicalizeUrlKey(rawUrl) {
    ...
    try {
        ...
        const normalizedSearch = sorted.length > 0 ? `?${new URLSearchParams(sorted).toString()}` : "";
